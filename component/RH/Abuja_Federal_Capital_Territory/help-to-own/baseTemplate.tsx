...
export const FCTBaseHtoLetter = (props: props) => {
  return (
    <div className="">
      ...
      <div className="h-[297mm] pt-10 p-6">
          ...
          <li>
            ...
            <ol className="px-4 mt-4 list-[lower-alpha]" type="A">
              <li>
                ...
                {props.minimumDownpayment}% 
                of the purchase price within two (2) weeks from the date of this
                offer and compliance to the terms incorporated therein.
          ...
          <li>
            ...
            <ol className="px-4 mt-4 list-[lower-alpha]" type="A">
              ...
              <li>
                ...
                financed through the Rent to Own product of the Family Homes Fund Loan Scheme at an interest rate of {props.interestRate}% per annum for up to a
                tenor of {props.tenor} years subject to terms and conditions.
              </li>
            </ol>
          </li>
        </ol>
        <p className="text-sm px-8 mt-4">
          ...
          provided be herein and return the duly signed copy of this
          Provisional offer.
        </p>
